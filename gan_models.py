...
from denoiser.utils import init_weights, get_padding
...
class MelGenerator(torch.nn.Module):
    def __init__(self, h):
...
class HifiGenerator(torch.nn.Module):
    def __init__(self):
        ...
        self.ups = nn.ModuleList()
        self.ups.append(nn.ConvTranspose1d(in_channels=1, out_channels=64, kernel_size=12, stride=2, padding=5))
        self.ups.append(nn.Conv1d(in_channels=64, out_channels=128, kernel_size=11, stride=1, padding=5))
        self.ups.append(nn.Conv1d(in_channels=128, out_channels=128, kernel_size=11, stride=1, padding=5))
        # self.ups.append(nn.ConvTranspose1d(in_channels=128, out_channels=128, kernel_size=12, stride=2, padding=5))
        self.ups.append(nn.Conv1d(in_channels=128, out_channels=256, kernel_size=11, stride=1, padding=5))
        self.ups.append(nn.Conv1d(in_channels=256, out_channels=1, kernel_size=11, stride=1, padding=5))
